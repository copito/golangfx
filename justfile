# Justfile to help get up and running with Application
...
# Default command, invoke by `just` to show available actions
default:
	just --list
...
build:
	echo "Building..."
	go build -o bin/main {{ENTRYPOINT_PATH}}
...
sqlc_clean:
	rm -rf ./src/internal/repository/* && touch ./src/internal/repository/.keep
