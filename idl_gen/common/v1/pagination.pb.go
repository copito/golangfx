...
const file_common_v1_pagination_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/v1/pagination.proto\x12\tcommon.v1\"2\n" +
	"\x11PaginationRequest\x12\x1d\n" +
	"\n" +
	"page_token\x18\x01 \x01(\tR\tpageToken\"l\n" +
	"\x12PaginationResponse\x12&\n" +
	"\x0fnext_page_token\x18\x01 \x01(\tR\rnextPageToken\x12.\n" +
	"\x13previous_page_token\x18\x02 \x01(\tR\x11previousPageTokenB\x9c\x01\n" +
	"\rcom.common.v1B\x0fPaginationProtoH\x02P\x01Z3github.com/copito/runner/idl_gen/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
